...
# Sonidos
SOUND_BOMB_PATH = os.path.join(ASSETS_DIR, "Banda Sonora", "Bombs", "bomb.wav")
EXPLOSION_SOUND = pygame.mixer.Sound(SOUND_BOMB_PATH)
EXPLOSION_SOUND.set_volume(0.35)

FOOTSTEP_SOUND_PATH = os.path.join(ASSETS_DIR, "Banda Sonora", "movimiento", "pasos.wav")
FOOTSTEP_SOUND = pygame.mixer.Sound(FOOTSTEP_SOUND_PATH)
FOOTSTEP_SOUND.set_volume(1)

COLOCAR_BOMBA_SOUND_PATH = os.path.join(ASSETS_DIR, "Banda Sonora", "Bombs", "colocar_bomba.wav")
COLOCAR_BOMBA_SOUND = pygame.mixer.Sound(COLOCAR_BOMBA_SOUND_PATH)
COLOCAR_BOMBA_SOUND.set_volume(0.35)

COGER_HABILIDAD_SOUND_PATH = os.path.join(ASSETS_DIR, "Banda Sonora", "habilidades", "coger_habilidad.wav")
COGER_HABILIDAD_SOUND = pygame.mixer.Sound(COGER_HABILIDAD_SOUND_PATH)
COGER_HABILIDAD_SOUND.set_volume(0.35)

COGER_MALDICION_SOUND = pygame.mixer.Sound(os.path.join("assets", "Banda Sonora", "habilidades", "coger_maldicion.mp3"))
...
ABILITY_EXPLOSION_FRAMES = [load_image("habilidad_ex" + str(i) + ".png", (40, 40),
                                       folder=os.path.join(ASSETS_DIR, "Habilidades", "explosion"))
                            for i in range(1, 18)]
