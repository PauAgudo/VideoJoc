...
def pantalla_controles(screen, fondo_pausa):
    ...
    flecha_rect.bottomleft = (310, 600)
    ...
    # --- VARIABLES DE ESTADO PARA EL MENÚ INTERNO ---
    ...
    while running:
        ...
        # Dibujado de textos de opciones
        ...
        # Dibujado del recuadro azul de selección
        padding = 10
        ...
        if indice_fila1 == 0:
            if indice_fila2 == 0:  # y la opción es "Menú"
                imagen_a_mostrar = img_teclado_menu
            else:  # y la opción es "Combate"
                imagen_a_mostrar = img_teclado_combate
        # Si la opción es "Mando"
        else:
            if indice_fila2 == 0:  # y la opción es "Menú"
        ...
        if imagen_a_mostrar:
            # Escala la imagen para que encaje bien en el centro
            imagen_scaled = pygame.transform.scale(imagen_a_mostrar, (550, 340))
            offset_vertical = 50
        ...
        # Dibujado de la flecha de volver
        if flecha_rect.collidepoint(mouse_pos):
